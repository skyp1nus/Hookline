...
public class UploadJob
{
    ...
    /// <summary>Target Google account (shared Connections account id), resolved from the channel
    /// mapping (null → default account). Plain value — no cross-schema FK to <c>connections</c>.</summary>
